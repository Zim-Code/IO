...
namespace ZimCode.IO
{
    ...
    public class Operation
    {
        ...
        internal Operation(string label, Type paramType = null, Type returnType = null)
        {
            Label = label;
            ParamType = paramType;
        ...
        private Operation(string label, Action action)
        {
            Label = label;
        ...
        /// </summary>
        /// <value>The label of the operation.</value>
        ...
        public static Operation Do(string label, Action action)
        {
            return new Operation(label, action);
        }
        ...
        public static Operation Consume<TParam>(string label, Action<TParam> action)
        {
            return new ConsumeOperation<TParam>(label, action);
        }
        ...
        public static Operation ConsumeGenerate<TParam, TResult>(string label, Func<TParam, TResult> func)
        {
            return new GenerateOperation<TParam, TResult>(label, func);
        }
        ...
        /// <param name="func">Func.</param>
        /// <typeparam name="TResult">The result type.</typeparam>
        public static Operation Generate<TResult>(string label, Func<TResult> func)
        {
            return new GenerateOperation<object, TResult>(label, (o) => func());
        }
    }
    ...
    class ConsumeOperation<TParam> : Operation
    {
        ...
        internal ConsumeOperation(string label, Action<TParam> action)
            : base(label, typeof(TParam))
        {
            if (action == null)
                throw new ArgumentNullException(nameof(action));
            this.action = action;
    ...
    class GenerateOperation<TParam, TResult> : Operation
    {
        ...
        internal GenerateOperation(string label, Func<TParam, TResult> func)
            : base(label, typeof(TParam), typeof(TResult))
        {
            this.func = func;
        }
